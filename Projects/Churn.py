...
accuracy = accuracy_score(y_test,np_pred)
print("Accuracy of Numpy Logistic:" , accuracy)
precision = precision_score(y_test,np_pred)
print("Precision Score of Numpy Logistic:",precision)
recall = recall_score(y_test,np_pred)
print("Recall Score of Numpy Logistic  :",recall)
f1 = f1_score(y_test,np_pred)
print("F1 Score Score of Numpy Logistic:",f1)
roc_auc = roc_auc_score(y_test,np_pred_prob)
print("ROC AUC  Score of Numpy Logistic:",roc_auc)
precision_recall = precision_recall_curve(y_test, np_pred_prob)
print(f"Precision Recall Curve: {precision_recall}")
average_precision = average_precision_score(y_test, np_pred_prob)
print(f"PR- AUC of Numpy Logistic: {average_precision}")
print("------------------------ Confusion Matrix -------------------------------------------")
...
#print(f"Precision Recall Curve of Tuned Model: {precision_recall_curve(y_test, y_pred_prob_grid)}")
